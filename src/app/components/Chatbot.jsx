...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: 'Hi! I\'m your Space Port assistant. I can help you with NASA exoplanet data pipelines, query building, and any questions about our library. How can I assist you today?'
    }
  ]);
  ...
  const sendMessage = async (e) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { 
        role: 'assistant', 
        content: 'I apologize, but I\'m having trouble connecting right now. Please try again or check our documentation for help with Space Port.' 
      }]);
    } finally {
      setIsLoading(false);
    }
